...
module.exports.handleEvent = async function ({
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "kamine") || (event.body.toLowerCase() == "kutte")) {
     return api.sendMessage("कुत्ता क**** मत कहा करो मैं इंसान हूं 🙂🤟", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "aalu") ||(event.body.toLowerCase() == "Aniya")) {
     return api.sendMessage("अनिया सिर्फ मेरी मम्मी है उनसे दूर रहो 🤨🤬", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "「๛⃝₍𝐒͜͡𝐚𝐮𝐫͜͡𝐚𝐛𝐡₎̚ 」࿐『𝐱͜͡⃝ᴆ』浴'") || (event.body.toLowerCase() == "Saurabh")) {
     return api.sendMessage("मेरा बॉस बीजी है सायद किसी काम में मुझे बताओ किया काम है। मैं बॉस को बता दूंगा 🙂✌️ ", threadID);
   };
