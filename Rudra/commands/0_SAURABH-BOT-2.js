...
module.exports.config = {
  ...
  description: "ALL REPLY MR SAURABH SHARMA",
...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
    ...
    if ((event.body.toLowerCase() == "Abhi Nahi") || (event.body.toLowerCase() == "abhi nahi") || (event.body.toLowerCase() == "Abhi nhi") || (event.body.toLowerCase() == "Abhi Nahi kiya")) {
     return api.sendMessage("जल्दी करो ना मम्मी 😒", threadID);
   };
...
if ((event.body.toLowerCase() == "Tharki") || (event.body.toLowerCase() == "tharki") || (event.body.toLowerCase() == "tharak pan") || (event.body.toLowerCase() == "sala tharki") || (event.body.toLowerCase() == "Sala tharki")) {
  ...
  if ((event.body.toLowerCase() == "kya hua") || (event.body.toLowerCase() == "kiya hua") || (event.body.toLowerCase() == "tya hua") || (event.body.toLowerCase() == "kiya hua")) {
   ...
   mess = "{name}"   //THIS BOT IS MADE BY SAURABH BABU
